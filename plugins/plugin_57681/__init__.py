...
class Plugin57681Plugin(BasePlugin):
    """解释器测试
    这是通过插件导入功能创建的插件类"""
    ...
    def __init__(self, plugin_id, config_manager=None):
        ...
        self._entry_module_path = os.path.join(os.path.dirname(__file__), 'test_interpreter.py')
        self._entry_module_name = 'test_interpreter'
        self._entry_function_name = 'test_interpreter'
